...
model = Sequential([
    ...
    GlobalMaxPooling1D(),  # Reduces sequence into a fixed-length vector
    Dense(64, activation='relu'),  # Fully connected layer
    Dropout(0.5),  # Regularization
    Dense(y_categorical.shape[1], activation='softmax')  # Output layer (multi-class classification)
])
...
# Analyse the model with the all metrics
...
#save the model
model.save('CyberTrollModel_CNN.keras')